...
class TestDFS(TestCase):
    ...
    def test_ajoute_voisins(self):
        ...
        # verifie que les elements deja presents dans la liste soient en tete
    ...
    def test_dfs(self):
        self.assertLessEqual(DFSSolver(self.g1).solve(self.n['a'], self.n['b']), 4)
        self.assertLessEqual(DFSSolver(self.g1).solve(self.n['a'], self.n['c']), 4)
        self.assertLessEqual(DFSSolver(self.g1).solve(self.n['a'], self.n['d']), 4)
        self.assertEqual(DFSSolver(self.g1).solve(self.n['a'], self.n['e']), None)
